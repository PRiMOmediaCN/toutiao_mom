...
imgloading.onload=function(){
    img_arr=['images/0.png','images/1.png','images/10.png','images/11.png','images/2.png','images/3.png','images/4.png','images/5.png','images/6.png','images/7.png','images/7_0.png','images/7_1.png','images/7_2.png','images/7_3.png','images/7_4.png','images/7_5.png','images/7_6.png','images/7_7.png','images/7_8.png','images/7_9.png','images/8.png','images/9.png','images/age_left_bg.png','images/age_right_bg.png','images/dial_bt.png','images/dial_close.png','images/dot_1.png','images/dot_2.png','images/img_wall_1.png','images/img_wall_2.png','images/img_wall_3.png','images/img_wall_4.png','images/img_wall_5.png','images/img_wall_6.png','images/loading.jpg','images/p1_1.png','images/p1_bg.jpg','images/p2_1.png','images/p2_10.png','images/p2_11.png','images/p2_12.png','images/p2_13.png','images/p2_14.png','images/p2_15.png','images/p2_16.png','images/p2_2.png','images/p2_3.png','images/p2_4.png','images/p2_5.png','images/p2_6.png','images/p2_7.png','images/p2_8.png','images/p2_9.png','images/p2_bg.jpg','images/p3_bg.jpg','images/p3_bt.png','images/p4_bt_1.png','images/p4_bt_2.png','images/p4_mb.png','images/p5_bt_1.png','images/p5_bt_2.png','images/p5_left.png','images/p5_right.png','images/p6_1.png','images/p6_bg.jpg','images/p6_bt.png','images/p7_bg.jpg','images/p8_1.png','images/p8_2.png','images/p8_3.png','images/p8_4.png','images/p8_5.png','images/p8_bt_1.png','images/p8_bt_2.png',];
...
<!--        <input id="fileUpload" class="posit3" type="file" name="fileUpload" onChange="return ajaxFileUpload('fileUpload');" accept="image/*" />-->
    ...
    <div id="p5" class="page posit9 dpl">
        ...
        <div id="dot_bar" class="posit3">
            ...
            <img id="dot_6" class="dot_pl fl" src="images/dot_2.png">
        </div>
...
$(document).ready(function() {
    ...
    function cheakform() {
        ...
        $('#p8').fadeIn(500,function () {
            ...
            $('#p8_3').animate({width:130/p+'px',height:74/p+'px',left:350/p+'px',top:710/p+'px',opacity:0.6},p8_date_1,function () {
                $('#p8_3').animate({width:147/p+'px',height:84/p+'px',left:370/p+'px',top:710/p+'px',opacity:1},p8_date_1);
            });
...
function getWidth(){
    ...
    $('#dot_bar').width(140/p).height(18/p).css({left:(x-140/p)/2+'px',top:978/p+'px'});
    ...
    $('#age_left_lab,#age_right_lab').width(82/p).height(78/p).css({left:0/p+'px',top:0/p+'px',lineHeight:78/p+'px',fontSize:30/p+'px'});
    $('#age_right_bar').width(82/p).height(78/p).css({left:494/p+'px',top:288/p+'px'});
    //p6
    $('#p6_1').width(125/p).height(100/p).css({left:530/p+'px',top:960/p+'px'});
    $('#p6_bt').width(312/p).height(161/p).css({left:(x-312/p)/2+'px',bottom:90/p+'px'});
    //
